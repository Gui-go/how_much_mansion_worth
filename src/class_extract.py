...
class ClassExtract:
    ...
    def __init__(self, first_page, extract_save_address):
        self.first_page = first_page
        self.extract_save_address = extract_save_address
        self.browser = Firefox()
        self.browser.get(first_page)
        sleep(2)
        self.df = pd.DataFrame()
        logging.info('Object from ClassExtract created successfully')
    ...
    def save(self):
        self.df.to_csv(self.extract_save_address)
    ...
    def shape(self):
        ...
        logging.info(f'Data {self.df.shape} shaped')
